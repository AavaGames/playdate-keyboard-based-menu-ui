...
---@overload fun(text: string, assignedGlyph: string, closeKeyboardOnSelect: boolean, closeMenuOnSelect: boolean, allMenus: boolean, startingValue: boolean, selectionFunction: function): MenuItemBool
